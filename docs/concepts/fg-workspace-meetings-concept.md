# FG Workspace — Meeting Concept

**Status:** Consolidated product/domain/UX concept for the Meeting MVP  
**Intended repository location:** replace or merge into the canonical `domain/meetings.md` rather than keeping parallel versioned concepts  
