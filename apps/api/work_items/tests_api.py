...
def _setup_test_data():
    ...
    wi = create_work_item(
        ...
        type=WorkItem.Type.TASK, title="Rewrite Introduction",
...
class WorkItemCSRFRegressionTest(TestCase):
    ...
    def test_work_item_patch_requires_csrf(self):
        ...
        wi = create_work_item(
            ...
            type=WorkItem.Type.TASK, title="CSRF Task",
        )
...
class WorkItemAdminTest(TestCase):
    ...
    def setUp(self):
        ...
        self.project = Project.objects.create(
            name="Admin Test", research_group=self.group, created_by=self.superuser,
        )
